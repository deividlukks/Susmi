...
import { Home, CheckSquare, Calendar, BarChart3, LogOut, Users, Target, FolderKanban } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <div className="fixed inset-y-0 left-0 z-50 flex h-screen w-64 flex-col bg-gray-900 text-white">
